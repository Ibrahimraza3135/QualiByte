...
export default function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>{pageMeta[currentPage]?.title || 'QualiByte'}</title>
        <meta name="description" content={pageMeta[currentPage]?.description || ''} />
        <link rel="canonical" href={`https://qualibyte.co/${currentPage}`} />
        ...
        <meta property="og:url" content={`https://qualibyte.co/${currentPage}`} />
      </Helmet>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            >
              Quali<span className="text-amber-600">Byte</span>
            </button>
