      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "logo": "https://qualibyte.co/logo.png", // replace with actual logo
            "sameAs": [
              "https://www.facebook.com/QualiByte",
              "https://twitter.com/QualiByte",
              "https://www.linkedin.com/company/QualiByte"
            ],
            "contactPoint": {
              "@type": "ContactPoint",
              "email": "adrian@qualibyte.co",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-zinc-900 mt-10 pt-6 text-center text-sm">
            <p className="text-gray-500">
              &copy; {currentYear} QualiByte. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
