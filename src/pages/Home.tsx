...
export default function Home({ onNavigate }: HomeProps) {
  ...
  const testimonials = [
    {
      ...
      content:
        'QualiByte helped us establish credibility in our industry. Their expertise with Wikipedia guidelines was invaluable.',
      rating: 5,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-ash-white">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Professional Wikipedia Page Creation Services | QualiByte</title>
        <meta
          name="description"
          content="QualiByte offers professional Wikipedia page creation, editing, and notability assessment services that fully comply with Wikipedia guidelines."
        />
        <link rel="canonical" href="https://qualibyte.co/" />
        ...
        />
        <meta property="og:url" content="https://qualibyte.co/" />
