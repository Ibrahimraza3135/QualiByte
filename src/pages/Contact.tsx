...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Contact QualiByte | Wikipedia Page Consultation</title>
        <meta
          name="description"
          content="Get in touch with QualiByte for professional Wikipedia page creation, editing, and notability assessment services."
        />
        <link rel="canonical" href="https://qualibyte.co/contact" />

        {/* Open Graph */}
        <meta property="og:title" content="Contact QualiByte" />
        <meta
          property="og:description"
          content="Reach out for expert Wikipedia consulting, article creation, and page monitoring services."
        />
        <meta property="og:url" content="https://qualibyte.co/contact" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <AnimatedSection delay={100}>
            <div className="bg-white border border-transparent rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-amber-500/10 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <a
                href="mailto:adrian@qualibyte.co"
          ...
          <AnimatedSection delay={200}>
            <div className="bg-white border border-transparent rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-amber-500/10 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Location</h3>`n              <p className="text-gray-600 mb-1">Serving Clients Remotely</p>`n              <p className="text-sm text-gray-500">`n                Available worldwide for all time zones`n              </p>
            </div>
          </AnimatedSection>
