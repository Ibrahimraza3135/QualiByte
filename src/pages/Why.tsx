...
export default function Why({ onNavigate }: WhyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Why Choose QualiByte | Wikipedia Experts</title>
        <meta
          name="description"
          content="Learn why QualiByte is the leading Wikipedia service provider. We ensure your page is compliant, accurate, and maximizes survival chances."
        />
        <link rel="canonical" href="https://qualibyte.co/why" />

        {/* Open Graph */}
        <meta property="og:title" content="Why Choose QualiByte | Wikipedia Experts" />
        <meta
        ...
        />
        <meta property="og:url" content="https://qualibyte.co/why" />
